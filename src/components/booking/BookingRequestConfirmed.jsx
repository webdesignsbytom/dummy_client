  ...
  return (
    <section className='grid justify-center items-center'>
      <div className='bg-colour1 shadow-xl rounded-2xl p-6 max-w-sm text-center'>
        <h2 className='text-2xl font-semibold text-colour7 mb-4'>
          Booking Request Received
        </h2>
        <p className='text-colour8 mb-6'>
          Your booking request has been sent successfully. Please await
          confirmation from the owner — we’ll notify you as soon as it’s
          confirmed.
        </p>
